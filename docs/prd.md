...
ERC20 토큰에 대한 Lockup(잠금) 메커니즘을 구현하여, 설정된 기간 동안 토큰을 안전하게 보관하고 점진적으로 해제하는 스마트 컨트랙트 개발

**원본 사용 사례:** SUT 토큰 (Polygon Mainnet: `0x98965474EcBeC2F532F1f780ee37b0b05F77Ca55`)
